      ...
      if (response.ok) {
        ...
        if (Array.isArray(data.data)) {
          ...
          const companyNames = new Set(
            data.data.map((prospect) => prospect.companyName)
          );
          ...
          <section aria-labelledby="prospects-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                /> */}
                  <CompanyNameFilter
                    selectedCompanies={[]} // Assuming you don't need this prop, or you can pass a relevant array
                    handleCompanySelection={handleCompanyNameInput}
                    companySearchTerm={companyName}
                    handleCompanySearchChange={handleCompanyNameInput}
                  />
                </div>
              </form>
